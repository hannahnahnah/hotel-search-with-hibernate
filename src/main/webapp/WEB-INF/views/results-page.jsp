...
<h1>Hotels in ${resultCityDisplay}</h1>
			...
			<div class="list-group">
				<c:forEach var="resultList" items="${listOfHotels}">
					<a href="/details-page" class="list-group-item" name="resultList"> <!-- cant pass this parameter like this... ${resultList.name} doesnt work either-->
